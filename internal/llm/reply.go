...
func (g *ReplyGenerator) StreamTaskResultReport(ctx context.Context, history []Message, reportContext string, onDelta func(string) error) error {
	...
	5. 如果任务信息里额外带了“产物交付”说明，可以自然补一句“我已经发到微信了，你可以看一下”这类话，但不要夸张展开。
	6. 如果任务信息里没有“产物交付”说明，就不要主动编造文件、图片或发送情况。
	7. 只基于给出的任务信息回答，不要编造新事实。
	8. 如果通知类型是“历史产物补投递通知”，要明确这是之前没送达的产物刚刚重新投递了，不要说成“任务刚完成”。
	9. 如果只有一个任务，就直接说重点；如果有多个任务，简短合并说明。
